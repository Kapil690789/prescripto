...
export default function Appointment() {
  ...
  const getAvailableSlots = async () => {
    if (!docInfo || !docInfo.slots_booked) return; // this line we have addd
    setDocSlots([])
  ...
  return docInfo &&  (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4 '>
         ...
         <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>  
               {/*----Doctor Info : name ,degree, expeirence  ----- */}
        ...
        <div className="flex items-center gap-4 w-full  overflow-x-scroll mt-4  ">
    {
      docSlots.length && docSlots[slotIndex].map((item, index) => (
        ...
        <button onClick={bookAppointment} className='bg-primary text-white text-smm font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>

      {/*--- listing relted doctors */}
